...
ActiveRecord::Schema[7.0].define(version: 2022_11_25_105514) do
  ...
  create_table "ratings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["brewery_id"], name: "index_ratings_on_brewery_id"
  ...
  add_foreign_key "ratings", "breweries"
